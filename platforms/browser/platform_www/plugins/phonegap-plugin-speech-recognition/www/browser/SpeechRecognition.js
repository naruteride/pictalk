cordova.define("phonegap-plugin-speech-recognition.SpeechRecognition", function(require, exports, module) { if (!window.SpeechRecognition && window.webkitSpeechRecognition) {
